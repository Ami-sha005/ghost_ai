...
Database                       Prisma + PostgreSQL                     Relational metadata: projects, 
                                                                       collaborators, specs, task runs

Canvas                         Liveblocks + React Flow                 Real-time collaborative canvas, presence,
                                                                       and cursors

Background tasks               Triager.dev                             Durable Al generation workflows
...
trigger - Long-running background jobs: Al design generation and spec generation.
lib - Shared infrastructure: Prisma client, access control helpers, and utilities.
components - Ul composition: canvas surfaces, sidebars, dialogs, and components interactive.elements.
...
1. Request handlers do not run long-lived Al work - that belongs in background tasks.
