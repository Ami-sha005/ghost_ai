  ...
  return (
    <div className="min-h-screen bg-[var(--bg-base)] text-[var(--text-primary)]">
      <div className="mx-auto grid min-h-screen max-w-7xl grid-cols-1 gap-8 px-4 py-10 lg:grid-cols-2">
        <aside className="relative flex flex-col justify-between overflow-hidden rounded-[2rem] border border-[var(--border-default)] bg-[linear-gradient(135deg,rgba(0,24,46,0.96),rgba(4,9,20,0.96))] p-10 text-[var(--text-primary)] shadow-[0_35px_90px_-55px_rgba(0,200,212,0.35)]">
          <div className="absolute inset-0 bg-[radial-gradient(circle_at_top_left,rgba(0,200,212,0.18),transparent_28%),radial-gradient(circle_at_bottom_right,rgba(100,87,249,0.18),transparent_22%)]" />
          <div className="relative space-y-6">
            <div className="inline-flex items-center gap-3 rounded-full bg-[rgba(0,200,212,0.12)] px-4 py-2 text-xs uppercase tracking-[0.24em] text-[var(--accent-primary)]">
              <span className="inline-flex h-8 w-8 items-center justify-center rounded-full bg-[var(--accent-primary)] text-xs font-semibold text-[var(--bg-base)]">
                G
              </span>
              Ghost AI
            </div>
          ...
          <ul className="relative space-y-4 text-sm text-[var(--text-secondary)]">
            <li className="flex items-start gap-3">
              <span className="mt-1 inline-flex h-2.5 w-2.5 rounded-full bg-[var(--accent-primary)]" />
        ...
        <main className="flex items-center justify-center px-4">
          <div className="w-full max-w-md rounded-[2rem] border border-[var(--border-default)] bg-[var(--bg-surface)] p-8 shadow-[0_40px_120px_-60px_rgba(0,0,0,0.8)]">
            <div className="mb-8 space-y-3 text-center">
              <span className="text-xs uppercase tracking-[0.32em] text-[var(--text-faint)]">Sign in to Ghost AI</span>
            ...
            <p className="mt-6 text-center text-sm text-[var(--text-secondary)]">
              ...
              <Link className="font-medium text-[var(--accent-primary)]" href="/sign-up">
                Sign up
              </Link>
            </p>
          </div>
